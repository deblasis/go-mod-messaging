...
Messaging client library for use by Go implementation of EdgeX micro services.  This project contains the abstract Message Bus interface and an implementation for MQTT, and Redis Streams.
...
This library is used by Go programs for interacting with the Message Bus.
